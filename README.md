...
```bash
curl -sSL https://raw.githubusercontent.com/ipod86/IoBroker_Script_Restore/main/script_restore.sh -o script_restore.sh && chmod +x script_restore.sh && ./script_restore.sh
```
